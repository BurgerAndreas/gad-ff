...
path_to_h5file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "relaxations", "ani1x", "ani1x.h5")
...
def download_ani1x(dest_path=path_to_h5file):
    ...
    os.system(f"curl -L -O 'https://springernature.figshare.com/ndownloader/files/18112775' -H 'User-Agent: Mozilla/5.0' -H 'Referer: https://springernature.figshare.com/' -o {dest_path}")
