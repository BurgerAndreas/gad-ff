...
from gadff.plot_molecules import plot_molecule_from_3d, plot_molecule_py3dmol
...
if __name__ == "__main__":
    ...
    # Plot the reactions
    plot_molecule_from_3d(smallest_sample.pos_reactant, "Reactant", plot_dir, atomic_numbers=smallest_sample.z)
    plot_molecule_from_3d(smallest_sample.pos_product, "Product", plot_dir, atomic_numbers=smallest_sample.z)
    plot_molecule_from_3d(smallest_sample.pos_transition, "Transition", plot_dir, atomic_numbers=smallest_sample.z)
