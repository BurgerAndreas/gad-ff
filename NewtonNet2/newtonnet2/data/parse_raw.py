...
from newtonnet2.data import MolecularStatistics
...
def parse_train_test(
    ...
    # define dataset type
    if in_memory:
        from newtonnet2.data import MolecularInMemoryDataset as MolecularDataset
    else:
        from newtonnet2.data import MolecularDataset
