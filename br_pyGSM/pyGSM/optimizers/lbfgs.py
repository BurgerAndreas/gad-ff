...
class lbfgs(base_optimizer):
    ...
    def optimize(
        ...
        num_coords = (
            molecule.num_coordinates - nconstraints - molecule.num_frozen_atoms * 3
        )
        ...
        for ostep in range(opt_steps):
            ...
            if self.k != 0:
                ...
                self.lm[self.end].s_prim = (
                    molecule.coord_obj.Prims.calcDiff(xyz, self.xyzp)
                    - self.cstep_prim.flatten()
                )
