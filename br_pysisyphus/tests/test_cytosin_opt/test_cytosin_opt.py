...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(Gaussian16, {"route": "HF/STO-3G"}, marks=using("gaussian16")),
        pytest.param(ORCA, {"keywords": "HF STO-3G tightscf"}, marks=using("orca")),
        # pytest.param(Psi4,
        # {"method": "scf", "basis": "sto-3g", "to_set": {"scf_type": "pk"}},
        # marks=using("psi4"),
        # ),
        pytest.param(PySCF, {"basis": "sto-3g"}, marks=using("pyscf")),
        pytest.param(
            Turbomole,
