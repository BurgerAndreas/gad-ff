...
from pysisyphus.line_searches.LineSearch import LineSearch, LineSearchNotConverged
...
class StrongWolfe(LineSearch):
    ...
    def zoom(
        self, alpha_lo, alpha_hi, phi_lo, phi_alpha_=None, alpha_0_=None, max_cycles=10
    ):
    ...
    def run_line_search(self):
        ...
        for i in range(self.max_cycles):
            ...
            if dphi_i >= 0:
                return self.zoom(
                    alpha_i, alpha_prev, phi_i, phi_alpha_=phi_i, alpha_0_=alpha_i
                )
            alpha_prev = alpha_i
