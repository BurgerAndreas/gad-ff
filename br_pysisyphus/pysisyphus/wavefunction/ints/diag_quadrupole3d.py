...
def diag_quadrupole3d_01(ax, da, A, bx, db, B, R):
    ...
    x7 = (
        ...
        * numpy.sqrt(x0)
        * numpy.exp(
            -x6 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x8 = x5 * x7
    x9 = x0 * (ax * A[1] + bx * B[1])
...
def diag_quadrupole3d_03(ax, da, A, bx, db, B, R):
    ...
    x16 = (
        ...
        * db
        * numpy.exp(
            -x15 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    ...
    result[1, 0, 6] = numpy.sum(
        -x19 * (x13 * (x22 * x58 + 2.0 * x56 + x59) + x22 * x64)
    )
    ...
    result[2, 0, 9] = numpy.sum(
        -x19 * (x13 * (x28 * x73 + 2.0 * x71 + x74) + x28 * x77)
    )
    return result
...
def diag_quadrupole3d_04(ax, da, A, bx, db, B, R):
    ...
    result[0, 0, 0] = numpy.sum(
        ...
        * x32
        * (
            x0 * (x11 * (x17 + x19) + x15 * (x14 + x8) + 3.0 * x21 + 3.0 * x24)
            + x26 * x3
        )
    )
...
def diag_quadrupole3d_11(ax, da, A, bx, db, B, R):
    ...
    x15 = (
        ...
        * db
        * numpy.exp(
            -x14 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def diag_quadrupole3d_12(ax, da, A, bx, db, B, R):
    ...
    x23 = (
        ...
        * db
        * numpy.exp(
            -x22 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def diag_quadrupole3d_13(ax, da, A, bx, db, B, R):
    ...
    x31 = (
        ...
        * db
        * numpy.exp(
            -x30 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def diag_quadrupole3d_22(ax, da, A, bx, db, B, R):
    ...
    x46 = x34 * x45
    x47 = (
        0.08333333333333333 * x0 * (x23 + 4.0 * x4 * x8)
        + 0.08333333333333333 * x27 * x31
    )
    x48 = x38**2
    x49 = 0.5 * x0
    x50 = x0**1.5 * x33
...
def diag_quadrupole3d_23(ax, da, A, bx, db, B, R):
    ...
    x46 = (
        ...
        * db
        * numpy.exp(
            -x45 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x47 = x0**1.5 * x46
...
def diag_quadrupole3d_33(ax, da, A, bx, db, B, R):
    ...
    x59 = (
        ...
        * db
        * numpy.exp(
            -x58 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    ...
    result[0, 0, 0] = numpy.sum(
        ...
        * (
            x0
            * (x33 * (x16 + x28 + x32) + x36 * x37 + x37 * x46 + x46 * x53 + 5.0 * x52)
            + x27 * x57
        )
    )
...
def diag_quadrupole3d_41(ax, da, A, bx, db, B, R):
    ...
    x60 = x3**2 * x7
    x61 = x57 * (
        x0 * (x23 * x34 + x29 * (x43 + x60) + 3.0 * x44 + 3.0 * x45) + x3 * x47
    )
...
def diag_quadrupole3d_43(ax, da, A, bx, db, B, R):
    ...
    x99 = x71 + x74
    x100 = x86 * (
        x0 * (x50 * x52 + 3.0 * x60 + x76 + 2.0 * x96 + 2.0 * x98) + x10 * x99
    )
...
def diag_quadrupole3d_44(ax, da, A, bx, db, B, R):
    ...
    x157 = x156 + x28
    x158 = (
        x0 * (x112 * x138 + 3.0 * x114 + 3.0 * x115 + x59 * (x113 + x157)) + x141 * x3
    )
    x159 = x100 * x158
    x160 = 3.0 * x133
    ...
    x529 = x100 * x526
    x530 = (
        x0 * (3.0 * x434 + x452 * x472 + x477 + 2.0 * x496 + 2.0 * x497) + x162 * x501
    )
    x531 = x492 * x99
    x532 = x123 * x531
    x533 = x107 * x4
    ...
    x666 = (
        x0 * (3.0 * x598 + x612 * x628 + x633 + 2.0 * x645 + 2.0 * x646) + x197 * x650
    )
