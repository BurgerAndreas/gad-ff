...
def kinetic3d_00(ax, da, A, bx, db, B):
    ...
    result[0, 0] = numpy.sum(
        ...
        * numpy.exp(
            -x2 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    return result
...
def kinetic3d_01(ax, da, A, bx, db, B):
    ...
    x12 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x11 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x13 = ax * (x0 + 2.0 * x5**2)
...
def kinetic3d_02(ax, da, A, bx, db, B):
    ...
    x21 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x20 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def kinetic3d_03(ax, da, A, bx, db, B):
    ...
    x29 = (
        ...
        * numpy.sqrt(x0)
        * numpy.exp(
            -x28 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def kinetic3d_04(ax, da, A, bx, db, B):
    ...
    result[0, 0] = numpy.sum(
        ...
        * (
            x33
            * (3.0 * x2 * (x18 + x22 + x23) + x27 * x5 + x9 * (2.0 * bx * x29 - x28))
            + x35 * x36
            + x36 * x38
        )
    )
    ...
    result[0, 7] = numpy.sum(
        x64 * (x14 * x54 * x58 + x17 * x52 * x58 + x51 * x61 * x77)
    )
    result[0, 8] = numpy.sum(
        x64 * (x14 * x45 * x68 + x17 * x43 * x68 + x41 * x71 * x79)
    )
...
def kinetic3d_10(ax, da, A, bx, db, B):
    ...
    x9 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x8 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x10 = ax * (x0 + 2.0 * x1**2)
...
def kinetic3d_11(ax, da, A, bx, db, B):
    ...
    x24 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x23 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x25 = x7 + B[1]
...
def kinetic3d_12(ax, da, A, bx, db, B):
    ...
    x33 = (
        ...
        * numpy.sqrt(x0)
        * numpy.exp(
            -x32 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def kinetic3d_13(ax, da, A, bx, db, B):
    ...
    x48 = (
        ...
        * db
        * numpy.exp(
            -x47 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x49 = numpy.sqrt(x0)
...
def kinetic3d_14(ax, da, A, bx, db, B):
    ...
    x110 = x12 * x53
    x111 = x110 * (
        x10 * (2.0 * bx * x108 - x107)
        + x101 * x64
        + x2 * (x109 + 3.0 * x79 + 3.0 * x82)
    )
    x112 = x110 * x6
    ...
    x118 = 3.0 * x90
    x119 = x113 * (
        x10 * (2.0 * bx * x117 - x116)
        + x105 * x73
        + x2 * (x118 + 3.0 * x91 + 3.0 * x94)
    )
    x120 = 3.0 * x35 + x45
    x121 = x120 * x2 + x41 * x9
    x122 = x56 * x65
    ...
    result[0, 4] = numpy.sum(
        x88 * (x31 * x66 * x76 + x31 * x68 * x74 + x44 * x64 * x87)
    )
    result[0, 5] = numpy.sum(x86 * (x44 * x65 * x93 + x57 * x93 * x97 + x96 * x97))
    result[0, 6] = numpy.sum(x72 * (x100 * x25 * x61 + x100 * x27 + x101 * x25 * x69))
    result[0, 7] = numpy.sum(
        x88 * (x25 * x74 * x84 + x25 * x76 * x81 + x27 * x74 * x81)
    )
    result[0, 8] = numpy.sum(
        x88 * (x25 * x66 * x96 + x25 * x68 * x93 + x27 * x66 * x93)
    )
    ...
    result[0, 12] = numpy.sum(
        x86 * (x19 * x81 * x96 + x19 * x84 * x93 + x20 * x81 * x93)
    )
    result[0, 13] = numpy.sum(
    ...
    result[1, 13] = numpy.sum(
        x72 * (x105 * x128 * x14 + x128 * x150 * x8 + x129 * x150)
    )
    ...
    result[2, 10] = numpy.sum(
        x63 * (x108 * x14 * x152 + x108 * x148 * x60 + x111 * x60)
    )
    result[2, 11] = numpy.sum(
        x72 * (x101 * x14 * x155 + x155 * x171 * x8 + x156 * x171)
    )
...
def kinetic3d_20(ax, da, A, bx, db, B):
    ...
    x20 = (
        ...
        * numpy.sqrt(x0)
        * numpy.exp(
            -x19 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def kinetic3d_23(ax, da, A, bx, db, B):
    ...
    result[0, 4] = numpy.sum(
        x113 * x88 * (x0 * (x47 + x52) + x103 * x108 + x108 * x109)
    )
    ...
    result[3, 6] = numpy.sum(
        ...
        * (
            ...
            + x255 * x7
            - x72
            * (-bx * (x12 * (x176 + x256 + x257) + x169 * x246) + 2.0 * x256 + x257)
        )
    )
    ...
    result[5, 9] = numpy.sum(
        ...
        * (
            ...
            + x274 * x7
            - x72
            * (-bx * (x12 * (x229 + x275 + x276) + x222 * x269) + 2.0 * x275 + x276)
        )
    )
    return result
...
def kinetic3d_24(ax, da, A, bx, db, B):
    ...
    x223 = x222 * x91
    x224 = (
        x11 * (2.0 * bx * x222 - x221) + x153 * x5 + x2 * (x39 + 3.0 * x41 + 3.0 * x45)
    )
    x225 = x160 * x75
    x226 = x166 + x225
    x227 = x226 * x91
    ...
    result[0, 3] = numpy.sum(
        x111 * (x104 * x109 * x82 + x104 * x64 * x91 + x108 * x109)
    )
    result[0, 4] = numpy.sum(
        x113 * (x112 * x64 * x86 + x57 * x88 * x99 + x57 * x90 * x97)
    )
    result[0, 5] = numpy.sum(
        x111 * (x118 * x123 * x77 + x118 * x64 * x87 + x122 * x123)
    )
    result[0, 6] = numpy.sum(
        x95 * (x125 * x127 * x82 + x125 * x128 * x91 + x126 * x127)
    )
    result[0, 7] = numpy.sum(
    ...
    result[0, 9] = numpy.sum(
        x95 * (x128 * x130 * x87 + x130 * x132 * x77 + x131 * x132)
    )
    result[0, 10] = numpy.sum(
        x85 * (x133 * x138 * x82 + x133 * x140 * x91 + x134 * x138)
    )
    result[0, 11] = numpy.sum(
    ...
    result[0, 14] = numpy.sum(
        x85 * (x133 * x144 * x77 + x133 * x146 * x87 + x134 * x144)
    )
    result[1, 0] = numpy.sum(x157 * (x148 * x151 * x91 + x155 * x75 + x156 * x75 * x82))
    result[1, 1] = numpy.sum(
        x163 * (x154 * x160 * x91 + x160 * x162 * x82 + x161 * x162)
    )
    result[1, 2] = numpy.sum(
        x163 * (x112 * x154 * x75 + x147 * x52 * x99 + x148 * x52 * x97)
    )
    result[1, 3] = numpy.sum(
        x113 * (x168 * x172 * x82 + x168 * x36 * x91 + x171 * x172)
    )
    result[1, 4] = numpy.sum(
    ...
    result[2, 2] = numpy.sum(
        x163 * (x154 * x195 * x87 + x195 * x197 * x77 + x196 * x197)
    )
    result[2, 3] = numpy.sum(
    ...
    result[2, 5] = numpy.sum(
        x113 * (x202 * x206 * x77 + x202 * x36 * x87 + x205 * x206)
    )
    result[2, 6] = numpy.sum(
    ...
    result[3, 0] = numpy.sum(
        x85 * (x219 * x223 * x82 + x219 * x224 * x91 + x220 * x223)
    )
    result[3, 1] = numpy.sum(
        x95 * (x149 * x227 * x82 + x149 * x230 * x91 + x153 * x227)
    )
    ...
    result[3, 13] = numpy.sum(
        x95 * (x10 * x130 * x247 + x130 * x15 * x230 + x131 * x247)
    )
    result[3, 14] = numpy.sum(
        x85 * (x10 * x219 * x248 + x146 * x15 * x219 + x220 * x248)
    )
    result[4, 0] = numpy.sum(
    ...
    result[4, 10] = numpy.sum(
        x157 * (x15 * x184 * x191 + x184 * x245 * x80 + x186 * x80)
    )
    ...
    result[4, 14] = numpy.sum(
        x157 * (x10 * x217 * x249 + x148 * x15 * x217 + x218 * x75)
    )
    result[5, 0] = numpy.sum(
        x85 * (x224 * x253 * x87 + x253 * x255 * x77 + x254 * x255)
    )
    result[5, 1] = numpy.sum(
        x95 * (x149 * x253 * x90 + x149 * x254 * x88 + x153 * x253 * x88)
    )
    result[5, 2] = numpy.sum(
        x95 * (x149 * x258 * x77 + x149 * x261 * x87 + x153 * x258)
    )
    ...
    result[5, 10] = numpy.sum(
        x85 * (x10 * x253 * x273 + x140 * x15 * x253 + x254 * x273)
    )
    result[5, 11] = numpy.sum(
        x95 * (x10 * x125 * x274 + x125 * x15 * x261 + x126 * x274)
    )
...
def kinetic3d_30(ax, da, A, bx, db, B):
    ...
    x25 = (
        ...
        * numpy.sqrt(x0)
        * numpy.exp(
            -x24 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def kinetic3d_32(ax, da, A, bx, db, B):
    ...
    result[6, 3] = numpy.sum(
        ...
        * (
            ...
            - x15
            * (-ax * (x14 * (x209 + x275 + x282) + x211 * x58) + 2.0 * x209 + x282)
            + x212 * x57
            + x281 * x7
            + x281 * x71
        )
    ...
    result[9, 5] = numpy.sum(
        ...
        * (
            ...
            - x15
            * (-ax * (x14 * (x261 + x292 + x296) + x263 * x68) + 2.0 * x261 + x296)
            + x264 * x67
            + x295 * x61
            + x295 * x7
        )
...
def kinetic3d_33(ax, da, A, bx, db, B):
    ...
    result[6, 4] = numpy.sum(
        -x10 * x120 * x141 * (x0 * x384 + x140 * x391 + x18 * x391)
    )
...
def kinetic3d_34(ax, da, A, bx, db, B):
    ...
    x334 = x112 * x333
    x335 = (
        x11 * (2.0 * bx * x333 - x332) + x2 * (3.0 * x21 + 3.0 * x26 + x29) + x257 * x6
    )
    ...
    result[0, 2] = numpy.sum(
        x115 * (x108 * x119 * x87 + x113 * x116 + x114 * x116 * x98)
    )
    result[0, 3] = numpy.sum(
    ...
    result[1, 0] = numpy.sum(
        x180 * (x103 * x179 * x96 + x112 * x176 * x177 + x178 * x96)
    )
    result[1, 1] = numpy.sum(
    ...
    result[1, 3] = numpy.sum(
        x196 * (x103 * x189 * x54 + x112 * x194 * x54 + x189 * x56)
    )
    result[1, 4] = numpy.sum(
    ...
    result[2, 2] = numpy.sum(
        x134 * (x108 * x220 * x83 + x220 * x222 * x98 + x221 * x222)
    )
    result[2, 3] = numpy.sum(
    ...
    result[3, 1] = numpy.sum(
        x134 * (x103 * x262 * x78 + x112 * x265 * x78 + x258 * x262)
    )
    result[3, 2] = numpy.sum(
    ...
    result[3, 6] = numpy.sum(
        x134 * (x103 * x277 * x33 + x112 * x282 * x33 + x277 * x40)
    )
    result[3, 7] = numpy.sum(
    ...
    result[3, 10] = numpy.sum(
        x180 * (x103 * x286 * x290 + x112 * x286 * x38 + x289 * x5)
    )
    ...
    result[5, 2] = numpy.sum(
        x134 * (x108 * x306 * x78 + x258 * x303 + x303 * x78 * x98)
    )
    result[5, 3] = numpy.sum(
    ...
    result[5, 5] = numpy.sum(
        x196 * (x108 * x309 * x47 + x309 * x312 * x98 + x311 * x312)
    )
    result[5, 6] = numpy.sum(
    ...
    result[5, 14] = numpy.sum(
        x180 * (x108 * x327 * x38 + x295 * x327 * x98 + x329 * x5)
    )
    result[6, 0] = numpy.sum(
    ...
    result[6, 3] = numpy.sum(
        x132 * (x103 * x24 * x341 + x112 * x24 * x344 + x256 * x341)
    )
    result[6, 4] = numpy.sum(
    ...
    result[6, 6] = numpy.sum(
        x115 * (x103 * x345 * x348 + x112 * x20 * x345 + x347 * x6)
    )
    ...
    result[8, 14] = numpy.sum(
        x180 * (x10 * x327 * x360 + x15 * x176 * x327 + x329 * x96)
    )
    result[9, 0] = numpy.sum(
    ...
    result[9, 5] = numpy.sum(
        x132 * (x108 * x24 * x376 + x24 * x373 * x98 + x256 * x373)
    )
    result[9, 6] = numpy.sum(
...
def kinetic3d_40(ax, da, A, bx, db, B):
    ...
    result[0, 0] = numpy.sum(
        ...
        * (
            x32
            * (3.0 * x1 * (x17 + x21 + x22) + x26 * x3 + x8 * (2.0 * ax * x28 - x27))
            + x35 * x36
            + x36 * x39
        )
    )
    ...
    result[7, 0] = numpy.sum(
        x63 * (x13 * x53 * x57 + x16 * x51 * x57 + x37 * x60 * x76)
    )
    result[8, 0] = numpy.sum(
        x63 * (x13 * x45 * x67 + x16 * x43 * x67 + x33 * x70 * x78)
    )
...
def kinetic3d_41(ax, da, A, bx, db, B):
    ...
    result[1, 2] = numpy.sum(
        x83 * (x41 * x76 * x80 + x41 * x77 * x78 + x42 * x75 * x82)
    )
    result[2, 0] = numpy.sum(x83 * (x47 * x58 * x94 + x47 * x67 * x93 + x61 * x81))
    result[2, 1] = numpy.sum(
        x83 * (x41 * x68 * x93 + x41 * x69 * x91 + x42 * x66 * x94)
    )
    result[2, 2] = numpy.sum(x83 * (x100 * x101 + x101 * x58 * x98 + x42 * x67 * x98))
    result[3, 0] = numpy.sum(
        x109 * (x104 * x108 * x63 + x104 * x44 * x72 + x107 * x108)
    )
    ...
    result[4, 0] = numpy.sum(
        x118 * (x31 * x78 * x93 + x31 * x80 * x91 + x44 * x61 * x82)
    )
    result[4, 1] = numpy.sum(
        x118 * (x36 * x87 * x93 + x36 * x89 * x91 + x39 * x87 * x91)
    )
    result[4, 2] = numpy.sum(
        x118 * (x100 * x36 * x78 + x36 * x80 * x98 + x39 * x78 * x98)
    )
    result[5, 0] = numpy.sum(
        x109 * (x121 * x125 * x58 + x121 * x44 * x67 + x124 * x125)
    )
    result[5, 1] = numpy.sum(
    ...
    result[12, 1] = numpy.sum(
        x109 * (x117 * x121 * x13 + x121 * x167 * x8 + x124 * x167)
    )
    result[12, 2] = numpy.sum(
        x109 * (x104 * x13 * x133 + x104 * x168 * x8 + x107 * x168)
    )
    result[13, 0] = numpy.sum(
...
def kinetic3d_42(ax, da, A, bx, db, B):
    ...
    x120 = x101 * x119
    x121 = (
        x10 * (2.0 * ax * x119 - x118) + x103 * x5 + x2 * (3.0 * x19 + 3.0 * x24 + x27)
    )
    x122 = x108 * x81
    x123 = x101 * x2
    x124 = x123 * x90
    ...
    result[0, 2] = numpy.sum(
        x107 * (x100 * x110 * x95 + x105 * x108 + x106 * x108 * x85)
    )
    result[0, 3] = numpy.sum(
        x93 * (x101 * x114 * x121 + x114 * x120 * x90 + x117 * x120)
    )
    result[0, 4] = numpy.sum(
        x107 * (x109 * x119 * x97 + x110 * x119 * x96 + x121 * x122 * x94)
    )
    result[0, 5] = numpy.sum(
        x93 * (x121 * x126 * x95 + x126 * x130 * x85 + x129 * x130)
    )
    ...
    result[1, 3] = numpy.sum(
        x137 * (x101 * x151 * x98 + x103 * x147 + x147 * x90 * x98)
    )
    result[1, 4] = numpy.sum(
    ...
    result[2, 2] = numpy.sum(
        x143 * (x104 * x158 * x95 + x158 * x160 * x85 + x159 * x160)
    )
    result[2, 3] = numpy.sum(
    ...
    result[3, 0] = numpy.sum(
        x177 * (x101 * x171 * x72 + x171 * x175 * x90 + x174 * x175)
    )
    result[3, 1] = numpy.sum(
        x185 * (x101 * x180 * x45 + x180 * x184 * x90 + x183 * x184)
    )
    result[3, 2] = numpy.sum(
        x185 * (x109 * x171 * x45 + x109 * x174 * x42 + x110 * x171 * x42)
    )
    result[3, 3] = numpy.sum(
        x177 * (x101 * x198 * x22 + x102 * x192 + x192 * x22 * x90)
    )
    result[3, 4] = numpy.sum(
    ...
    result[5, 0] = numpy.sum(
        x177 * (x202 * x206 * x85 + x202 * x72 * x95 + x205 * x206)
    )
    result[5, 1] = numpy.sum(
        x185 * (x202 * x42 * x97 + x202 * x45 * x96 + x205 * x42 * x96)
    )
    result[5, 2] = numpy.sum(
        x185 * (x209 * x213 * x85 + x209 * x45 * x95 + x212 * x213)
    )
    result[5, 3] = numpy.sum(
    ...
    result[6, 0] = numpy.sum(
        x137 * (x101 * x228 * x56 + x228 * x230 * x90 + x229 * x230)
    )
    ...
    result[9, 0] = numpy.sum(
        x137 * (x248 * x250 * x85 + x248 * x56 * x95 + x249 * x250)
    )
    result[9, 1] = numpy.sum(
    ...
    result[10, 0] = numpy.sum(
        x93 * (x101 * x267 * x48 + x263 * x266 + x266 * x48 * x90)
    )
    result[10, 1] = numpy.sum(
        x107 * (x101 * x269 * x30 + x269 * x271 * x90 + x270 * x28)
    )
    ...
    result[10, 5] = numpy.sum(
        x93 * (x126 * x14 * x267 + x126 * x276 * x9 + x129 * x276)
    )
    result[11, 0] = numpy.sum(
    ...
    result[11, 3] = numpy.sum(
        x137 * (x14 * x154 * x240 + x240 * x275 * x88 + x243 * x88)
    )
    result[11, 4] = numpy.sum(
        x143 * (x14 * x158 * x238 + x158 * x277 * x9 + x159 * x277)
    )
    result[11, 5] = numpy.sum(
        x137 * (x14 * x168 * x228 + x228 * x278 * x9 + x229 * x278)
    )
    result[12, 0] = numpy.sum(
    ...
    result[12, 3] = numpy.sum(
        x177 * (x14 * x198 * x202 + x202 * x279 * x9 + x205 * x279)
    )
    result[12, 4] = numpy.sum(
        x185 * (x14 * x183 * x209 + x209 * x280 * x9 + x212 * x280)
    )
    result[12, 5] = numpy.sum(
        x177 * (x14 * x171 * x226 + x171 * x281 * x9 + x174 * x281)
    )
    result[13, 0] = numpy.sum(
    ...
    result[13, 3] = numpy.sum(
        x137 * (x14 * x151 * x248 + x248 * x283 * x9 + x249 * x283)
    )
    result[13, 4] = numpy.sum(
        x143 * (x14 * x140 * x258 + x140 * x284 * x9 + x141 * x284)
    )
    result[13, 5] = numpy.sum(
        x137 * (x133 * x14 * x260 + x260 * x282 * x9 + x262 * x83)
    )
    ...
    result[14, 2] = numpy.sum(
        x107 * (x28 * x292 + x289 * x291 * x85 + x291 * x30 * x95)
    )
    result[14, 3] = numpy.sum(
        x93 * (x114 * x14 * x288 + x114 * x293 * x9 + x117 * x293)
    )
...
def kinetic3d_43(ax, da, A, bx, db, B):
    ...
    x163 = (
        x144 * x5
        + x18 * (2.0 * ax * x161 - x160)
        + x2 * (3.0 * x114 + 3.0 * x116 + x27)
    )
    x164 = 2.0 * x149
    x165 = x128 * (x152 + x164)
    ...
    result[3, 0] = numpy.sum(
        x242 * (x113 * x237 * x80 + x237 * x241 * x99 + x240 * x241)
    )
    ...
    result[5, 0] = numpy.sum(
        x242 * (x104 * x273 * x80 + x273 * x277 * x94 + x276 * x277)
    )
    result[5, 1] = numpy.sum(
    ...
    result[6, 1] = numpy.sum(
        x179 * (x113 * x310 * x44 + x310 * x313 * x99 + x312 * x313)
    )
    result[6, 2] = numpy.sum(
    ...
    result[9, 2] = numpy.sum(
        x179 * (x104 * x337 * x44 + x337 * x340 * x94 + x339 * x340)
    )
    result[9, 3] = numpy.sum(
    ...
    result[10, 1] = numpy.sum(
        x127 * (x113 * x23 * x363 + x23 * x362 * x99 + x353 * x362)
    )
    result[10, 2] = numpy.sum(
        x127 * (x129 * x23 * x359 + x129 * x353 * x357 + x131 * x23 * x357)
    )
    result[10, 3] = numpy.sum(
        x127 * (x113 * x20 * x365 + x365 * x367 * x99 + x366 * x6)
    )
    result[10, 4] = numpy.sum(
    ...
    result[11, 6] = numpy.sum(
        x173 * (x15 * x206 * x322 + x322 * x371 * x97 + x326 * x97)
    )
    ...
    result[13, 9] = numpy.sum(
        x173 * (x10 * x349 * x381 + x15 * x170 * x349 + x352 * x92)
    )
    result[14, 0] = numpy.sum(
    ...
    result[14, 2] = numpy.sum(
        x127 * (x104 * x23 * x392 + x23 * x391 * x94 + x353 * x391)
    )
    result[14, 3] = numpy.sum(
    ...
    result[14, 5] = numpy.sum(
        x127 * (x104 * x20 * x395 + x393 * x395 * x94 + x396 * x6)
    )
...
def kinetic3d_44(ax, da, A, bx, db, B):
    ...
    x199 = x128 * x198
    x200 = (
        x18 * (2.0 * ax * x198 - x197)
        + x185 * x6
        + x2 * (3.0 * x150 + 3.0 * x152 + x49)
    )
    x201 = 3.0 * x166
    x202 = 3.0 * x165
    x203 = 3.0 * x168 + x202
    ...
    x448 = (
        x11 * (2.0 * bx * x447 - x446) + x2 * (3.0 * x43 + 3.0 * x47 + x49) + x380 * x5
    )
    x449 = x193 + 3.0 * x284
    ...
    result[1, 3] = numpy.sum(
        x227 * (x119 * x221 * x95 + x128 * x226 * x95 + x160 * x221)
    )
    result[1, 4] = numpy.sum(
    ...
    result[2, 5] = numpy.sum(
        x227 * (x114 * x259 * x95 + x123 * x264 * x95 + x160 * x259)
    )
    result[2, 6] = numpy.sum(
    ...
    result[3, 1] = numpy.sum(
        x227 * (x119 * x293 * x69 + x128 * x297 * x69 + x293 * x72)
    )
    result[3, 2] = numpy.sum(
    ...
    result[5, 2] = numpy.sum(
        x227 * (x114 * x339 * x69 + x123 * x343 * x69 + x339 * x72)
    )
    result[5, 3] = numpy.sum(
    ...
    result[6, 1] = numpy.sum(
        x217 * (x119 * x386 * x77 + x128 * x390 * x77 + x381 * x386)
    )
    result[6, 2] = numpy.sum(
    ...
    result[6, 6] = numpy.sum(
        x217 * (x119 * x25 * x399 + x128 * x25 * x402 + x27 * x399)
    )
    result[6, 7] = numpy.sum(
    ...
    result[6, 10] = numpy.sum(
        x131 * (x119 * x406 * x412 + x128 * x31 * x406 + x411 * x6)
    )
    result[6, 11] = numpy.sum(
    ...
    result[9, 2] = numpy.sum(
        x217 * (x114 * x421 * x77 + x123 * x425 * x77 + x381 * x421)
    )
    result[9, 3] = numpy.sum(
    ...
    result[9, 9] = numpy.sum(
        x217 * (x114 * x25 * x434 + x123 * x25 * x437 + x27 * x434)
    )
    result[9, 10] = numpy.sum(
    ...
    result[9, 14] = numpy.sum(
        x131 * (x114 * x414 * x441 + x123 * x31 * x441 + x445 * x6)
    )
    result[10, 0] = numpy.sum(
    ...
    result[10, 6] = numpy.sum(
        x131 * (x119 * x460 * x462 + x128 * x20 * x460 + x461 * x5)
    )
    result[10, 7] = numpy.sum(
    ...
    result[14, 9] = numpy.sum(
        x131 * (x114 * x495 * x496 + x123 * x20 * x496 + x497 * x5)
    )
