...
def quadrupole3d_00(ax, da, A, bx, db, B, R):
    ...
    x4 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x3 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def quadrupole3d_01(ax, da, A, bx, db, B, R):
    ...
    x8 = (
        ...
        * numpy.sqrt(x0)
        * numpy.exp(
            -x7 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x9 = x6 * x8
...
def quadrupole3d_02(ax, da, A, bx, db, B, R):
    ...
    x13 = (
        ...
        * db
        * numpy.exp(
            -x12 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    ...
    # 36 item(s)
    result[0, 0, 0] = numpy.sum(
        x17 * (x0 * (2.0 * x4 + x5 + 4.0 * x7) + 2.0 * x10 * x6)
    )
...
def quadrupole3d_03(ax, da, A, bx, db, B, R):
    ...
    x19 = (
        ...
        * db
        * numpy.exp(
            -x18 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def quadrupole3d_11(ax, da, A, bx, db, B, R):
    ...
    x17 = (
        ...
        * db
        * numpy.exp(
            -x16 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    ...
    # 54 item(s)
    result[0, 0, 0] = numpy.sum(
        x20 * (x0 * (x1 + x11 + 2.0 * x6 + x9) + 2.0 * x15 * x7)
    )
...
def quadrupole3d_12(ax, da, A, bx, db, B, R):
    ...
    x27 = (
        ...
        * db
        * numpy.exp(
            -x26 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def quadrupole3d_13(ax, da, A, bx, db, B, R):
    ...
    x34 = (
        ...
        * db
        * numpy.exp(
            -x33 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x35 = x0**1.5 * x34
    x36 = x32 * x35
    ...
    x110 = 2.0 * x47
    x111 = (
        0.01666666666666667 * x0 * (4.0 * x100 + x109)
        + 0.01666666666666667 * x106 * x110
    )
    x112 = x39 + R[1]
...
def quadrupole3d_14(ax, da, A, bx, db, B, R):
    ...
    x226 = x170 * (
        x0 * (2.0 * x146 + 2.0 * x147 + 3.0 * x222 + 3.0 * x223) + x225 * x59
    )
    ...
    x258 = x214 * x257
    x259 = x182 * (
        x0 * (2.0 * x195 + 2.0 * x196 + 3.0 * x254 + 3.0 * x255) + x257 * x65
    )
...
def quadrupole3d_22(ax, da, A, bx, db, B, R):
    ...
    x38 = (
        ...
        * db
        * numpy.exp(
            -x37 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x39 = x0**1.5 * x38
...
def quadrupole3d_23(ax, da, A, bx, db, B, R):
    ...
    x55 = (
        ...
        * db
        * numpy.exp(
            -x54 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x56 = x0**1.5 * x55
    x57 = x53 * x56
...
def quadrupole3d_31(ax, da, A, bx, db, B, R):
    ...
    x36 = (
        ...
        * db
        * numpy.exp(
            -x35 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x37 = x0**1.5 * x36
    x38 = x34 * x37
...
def quadrupole3d_32(ax, da, A, bx, db, B, R):
    ...
    x56 = (
        ...
        * db
        * numpy.exp(
            -x55 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x57 = x0**1.5 * x56
    x58 = x54 * x57
...
def quadrupole3d_33(ax, da, A, bx, db, B, R):
    ...
    x69 = (
        ...
        * db
        * numpy.exp(
            -x68 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def quadrupole3d_41(ax, da, A, bx, db, B, R):
    ...
    x249 = x18 * x97
    x250 = x175 * (
        x0 * (2.0 * x163 + 2.0 * x164 + 3.0 * x234 + 3.0 * x235) + x244 * x67
    )
    x251 = x69 * x7
    x252 = x53 * x7
    x253 = x132 * x69
    ...
    x274 = x217 * x273
    x275 = x184 * (
        x0 * (2.0 * x208 + 2.0 * x209 + 3.0 * x264 + 3.0 * x265) + x271 * x81
    )
...
def quadrupole3d_42(ax, da, A, bx, db, B, R):
    ...
    x420 = x419 * x97
    x421 = (
        0.009523809523809524 * x0 * (3.0 * x107 + x21)
        + 0.009523809523809524 * x12 * x256
    )
