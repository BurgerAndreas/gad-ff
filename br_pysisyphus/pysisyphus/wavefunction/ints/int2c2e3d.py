...
def int2c2e3d_14(ax, da, A, bx, db, B):
    ...
    x50 = 0.5 * x49
    x51 = x4 * (x24 * x48 + x50) - x48 * x5 * (
        x13 - 2.0 * x14 * x15 * x16 * x4 * x5 * x9
    )
...
def int2c2e3d_23(ax, da, A, bx, db, B):
    ...
    result[3, 6] = numpy.sum(
        -x37 * (x103 + x118 * (2.0 * x134 + 3.0 * x84) + x129 * x34)
    )
    ...
    result[5, 9] = numpy.sum(
        -x37 * (x114 + x139 * (2.0 * x153 + 3.0 * x99) + x148 * x34)
    )
    return result
...
def int2c2e3d_24(ax, da, A, bx, db, B):
    ...
    x87 = 0.5 * x86
    x88 = x4 * (x25 * x85 + x87) - x5 * x85 * (
        x14 - 2.0 * x15 * x16 * x17 * x4 * x5 * x9
    )
    x89 = x3 * x88
    ...
    result[0, 4] = numpy.sum(
        x132
        * (x110 * (x123 * x131 * x23 + x129 * x130) + x128 + x3 * (x122 * x3 + x125))
    )
...
def int2c2e3d_33(ax, da, A, bx, db, B):
    ...
    result[0, 0] = numpy.sum(
        ...
        * (
            ...
            + x35
            * (-x1 * (x19 * x21 + 3.0 * x27) + x29 * (x18 * x25 + x28) + x32 * x34)
        )
    )
    result[0, 1] = numpy.sum(
        0.5
    ...
    result[1, 0] = numpy.sum(
        x208 * (-x17 * x201 * x205 * x8 + x200 * x48 + x206 * x207)
    )
    result[1, 1] = numpy.sum(
    ...
    result[1, 2] = numpy.sum(
        0.5
        * x224
        * (2.0 * x109 * x221 - x201 * x222 * x8 * x98 + 2.0 * x223 * x8 * x84)
    )
    ...
    result[2, 0] = numpy.sum(
        x208 * (-x17 * x205 * x246 * x8 + x207 * x247 + x245 * x48)
    )
    result[2, 1] = numpy.sum(
        0.5
        * x224
        * (2.0 * x150 * x247 * x84 - x222 * x246 * x63 * x8 + 2.0 * x248 * x81)
    )
    ...
    result[3, 7] = numpy.sum(
        0.5 * x314 * (2.0 * x206 * x243 + 2.0 * x232 * x313 + x312)
    )
    ...
    result[7, 1] = numpy.sum(
        x229 * (-x222 * x246 * x63 * x8 + x245 * x286 + x245 * x287)
    )
...
def int2c2e3d_34(ax, da, A, bx, db, B):
    ...
    result[0, 13] = numpy.sum(
        x115 * x4 * (x0 * (x255 * x79 - x282) + x228 * x284 + x283)
    )
    ...
    result[1, 3] = numpy.sum(
        ...
        * x314
        * (
            2.0 * x110 * (x310 * x4 + x312)
            + x311
            + 2.0 * x4 * (x110 * x310 + x308 * x4)
        )
    )
    result[1, 4] = numpy.sum(
        0.5
...
def int2c2e3d_41(ax, da, A, bx, db, B):
    ...
    result[0, 1] = numpy.sum(
        ...
        * (
            ...
            + x5
            * (
                x1 * (2.0 * x1 * x13 * x14 * x49 * x5 * x8 * x9 - x52)
                + x5 * (x53 + x55)
            )
        )
    )
    result[0, 2] = numpy.sum(
        ...
        * (
            ...
            + x5
            * (
                x1 * (2.0 * x1 * x13 * x14 * x5 * x60 * x8 * x9 - x63)
                + x5 * (x64 + x65)
            )
        )
    )
    ...
    result[0, 2] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x81
            * (x123 * x3 + x126 * x3 + x132 - x5 * (x113 * x62 + x122 * x3 + x133))
        )
    )
    result[0, 3] = numpy.sum(
        x84
    ...
    result[0, 1] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x95
            * (x111 * x3 + x137 * x71 + x144 - x7 * (x105 * x3 + x133 * x71 + x145))
        )
    )
    result[0, 2] = numpy.sum(
        x146
        * (
            ...
            * (
            ...
            + x95
            * (x161 * x3 + x184 * x71 + x191 - x7 * (x154 * x3 + x181 * x71 + x192))
        )
    )
    result[0, 3] = numpy.sum(
        x146
...
def int2c2e3d_44(ax, da, A, bx, db, B):
    ...
    result[0, 1] = numpy.sum(
        ...
        * (
            x110
            * (x137 * x3 + x164 * x89 + x171 - x50 * (x128 * x3 + x161 * x89 + x172))
            + x3
            * (
                x158 * x89
    ...
    result[0, 2] = numpy.sum(
        ...
        * (
            x110
            * (x194 * x3 + x219 * x89 + x225 - x50 * (x186 * x3 + x217 * x89 + x226))
            + x3
            * (
                x215 * x89
    ...
    result[0, 3] = numpy.sum(
        ...
        * (
            x110
            * (x244 * x3 + x263 * x96 + x270 - x50 * (x238 * x3 + x261 * x96 + x271))
            + x3
            * (
                x259 * x96
    ...
    result[0, 4] = numpy.sum(
        ...
        * (
            x110
            * (x281 * x3 + x296 * x96 + x302 - x50 * (x276 * x3 + x294 * x96 + x303))
            + x3
            * (
                x293 * x96
    ...
    result[0, 5] = numpy.sum(
        ...
        * (
            x110
            * (x3 * x323 + x341 * x96 + x349 - x50 * (x3 * x316 + x339 * x96 + x350))
            + x3
            * (
    ...
    result[0, 8] = numpy.sum(
        ...
        * (
            x110
            * (x3 * x397 + x3 * x398 + x401 - x50 * (x114 * x335 + x3 * x396 + x403))
