...
Nreactions = [
    len(b1),
    len(b2[df.N_bond_form == 1]),
    len(b2[df.N_bond_form == 2]),
    len(b3[df.N_bond_form == 2]),
    len(b3[df.N_bond_form == 3]),
    len(b4),
    len(b5),
]
...
# set labels
ax1.set_xlabel(
    "Reaction type", fontsize=15, fontweight="black", color="#333F4B", fontname="Arial"
)
ax1.set_ylabel(
    "Number of reactions",
    fontsize=15,
