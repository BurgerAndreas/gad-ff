...
from newtonnet1.layers import Dense
from newtonnet1.layers.shells import ShellProvider
from newtonnet1.layers.scalers import ScaleShift, TrainableScaleShift
from newtonnet1.layers.cutoff import CosineCutoff, PolynomialCutoff
from newtonnet1.layers.representations import RadialBesselLayer
...
class NewtonNet(nn.Module):
    ...
    activation: function
        activation function from newtonnet1.layers.activations
        you can aslo get it by string from newtonnet1.layers.activations.get_activation_by_string
