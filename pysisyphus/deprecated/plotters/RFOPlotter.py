...
class RFOPlotter:
    def __init__(self, calc, opt, figsize=(8, 6), save=False, title=True):
        self.opt = opt
        self.calc = calc
        ...
        self.fig, (self.ax, self.ax2) = plt.subplots(ncols=2, figsize=figsize)
    ...
    def plot(self):
        ...
        self.trust_region2 = Circle(
            (0, 0), radius=self.opt.trust_radii[0], **circle_kwargs
        )
