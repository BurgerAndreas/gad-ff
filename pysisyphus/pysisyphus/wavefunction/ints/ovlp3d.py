...
def ovlp3d_22(ax, da, A, bx, db, B):
    ...
    result[3, 3] = numpy.sum(
        x14 * (x0 * (2.0 * x26 + 4.0 * x40 + x5) + 2.0 * x37 * x46)
    )
    ...
    result[5, 5] = numpy.sum(
        x14 * (x0 * (2.0 * x35 + x5 + 4.0 * x50) + 2.0 * x49 * x54)
    )
    return result
...
def ovlp3d_31(ax, da, A, bx, db, B):
    ...
    result[6, 1] = numpy.sum(
        x13 * (x0 * (4.0 * x31 + 2.0 * x41 + x5) + 2.0 * x25 * x46)
    )
    ...
    result[9, 2] = numpy.sum(
        x13 * (x0 * (4.0 * x39 + x5 + 2.0 * x50) + 2.0 * x37 * x52)
    )
    return result
...
def ovlp3d_33(ax, da, A, bx, db, B):
    ...
    # 100 item(s)
    result[0, 0] = numpy.sum(
        x25 * (x0 * (4.0 * x10 + 5.0 * x14 + 6.0 * x15) + x20 * x21)
    )
...
def ovlp3d_34(ax, da, A, bx, db, B):
    ...
    # 150 item(s)
    result[0, 0] = numpy.sum(
        x33 * x37 * (3.0 * x0 * (x23 + x24 + 2.0 * x26) + x30 * x4)
    )
...
def ovlp3d_43(ax, da, A, bx, db, B):
    ...
    # 150 item(s)
    result[0, 0] = numpy.sum(
        x33 * x37 * (3.0 * x0 * (x23 + x24 + 2.0 * x26) + x3 * x30)
    )
...
def ovlp3d_44(ax, da, A, bx, db, B):
    ...
    # 225 item(s)
    result[0, 0] = numpy.sum(
        x42 * (x0 * (3.0 * x27 + 4.0 * x28 + 7.0 * x31) + x35 * x4)
    )
