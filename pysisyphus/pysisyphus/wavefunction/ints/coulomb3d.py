...
def coulomb3d_02(ax, da, A, bx, db, B, R):
    ...
    result[0, 0] = numpy.sum(
        x15
        * (x11 + 2.0 * x12 * (x10 * x12 - x3 * x9) - 2.0 * x3 * (x12 * x9 - x13 * x3))
    )
...
def coulomb3d_11(ax, da, A, bx, db, B, R):
    ...
    result[0, 0] = numpy.sum(
        x15
        * (x11 + 2.0 * x14 * (x10 * x12 - x3 * x9) - 2.0 * x3 * (x12 * x9 - x13 * x3))
    )
...
def coulomb3d_12(ax, da, A, bx, db, B, R):
    ...
    result[2, 0] = numpy.sum(
        -x26
        * (-2.0 * x13 * (x13 * x77 - x4 * x78) + x18 * (x13 * x78 - x4 * x79) + x76)
    )
...
def coulomb3d_13(ax, da, A, bx, db, B, R):
    ...
    result[0, 4] = numpy.sum(
        -x33
        * (x103 + x18 * (x107 * x4 - x110 * x5) - 2.0 * x3 * (x104 * x4 - x107 * x5))
    )
    result[0, 5] = numpy.sum(
    ...
    result[0, 7] = numpy.sum(
        x60 * (x3 * (x104 * x86 - x127) - x5 * (x107 * x86 - x129))
    )
    ...
    result[1, 3] = numpy.sum(
        -x60 * (x4 * (x124 - x138 * x98) - x5 * (x125 - x138 * x89))
    )
    ...
    result[2, 1] = numpy.sum(
        -x60
        * (x175 + x18 * (x178 * x4 - x180 * x5) - 2.0 * x4 * (x176 * x4 - x178 * x5))
    )
...
def coulomb3d_21(ax, da, A, bx, db, B, R):
    ...
    result[3, 0] = numpy.sum(
        -x25
        * (x15 * (x18 - x56 * x59 + x57 * x60) - x4 * (x22 - x57 * x59 + x58 * x60))
    )
...
def coulomb3d_22(ax, da, A, bx, db, B, R):
    ...
    result[2, 3] = numpy.sum(
        x64 * (x16 * (x182 * x91 - x197) - x4 * (x185 * x91 - x199))
    )
    ...
    result[3, 6] = numpy.sum(
        ...
        * (
            ...
            * (
                -3.0 * x161
                + x302
                * (-x481 * x6 + x56 * (x12 + x142 * x72 - x144 * x60) + 2.0 * x90)
                + 2.0 * x483 * x6
            )
            + x331 * x48
            + x6
...
def coulomb3d_24(ax, da, A, bx, db, B, R):
    ...
    result[3, 9] = numpy.sum(
        x125
        * (
            x4 * (x365 + x423 * x562 - x564 * x7)
            - x5 * (x368 + x423 * x564 - x565 * x7)
        )
    )
...
def coulomb3d_31(ax, da, A, bx, db, B, R):
    ...
    result[8, 0] = numpy.sum(
        x112 * (x3 * (x193 * x94 + x194) - x4 * (x188 * x94 + x196))
    )
...
def coulomb3d_32(ax, da, A, bx, db, B, R):
    ...
    result[0, 2] = numpy.sum(
        ...
        * (
            ...
            + x113
            * (-x156 + x158 * x49 + x163 * x36 + x163 * x49 + x36 * (x149 + x164))
            + x3
            * (
                x1 * (-x127 + x133 + x141)
                + x1 * (x133 - x157 + x158)
    ...
    result[6, 4] = numpy.sum(
        ...
        * (
            ...
            * (
                x200
                - x244 * (x159 + x171 * x203 - 2.0 * x198 * x244)
                + x305
                - x558 * x7
            )
            + x324
            ...
            * (
                ...
                + x244 * x558
                + x308
                + x7 * (x166 + x171 * x217 - 2.0 * x210 * x244)
            )
        )
    )
...
def coulomb3d_33(ax, da, A, bx, db, B, R):
        ...
        * (
            ...
            * (
                ...
                * (
                    -2.0 * x3 * x57
                    - x58
                    * (-x3 * x56 + x4 * (-x14 * x24 + x16 * x70 + x80) + x45 * x84)
                    + x62 * x76
                )
                + x62 * (x88 + x89 + x90)
            )
    ...
    result[1, 6] = numpy.sum(
        -x299
        * (
            -x24 * (x3 * x655 - x52 * x651)
            + 2.0 * x52 * (x3 * x651 - x52 * x653)
            + x652
        )
    )
    result[1, 7] = numpy.sum(
    ...
    result[1, 8] = numpy.sum(
        -x568
        * (
            -x24 * (x3 * x670 - x52 * x666)
            + 2.0 * x52 * (x3 * x666 - x52 * x668)
            + x667
        )
    )
    result[1, 9] = numpy.sum(
    ...
    result[2, 7] = numpy.sum(
        -x568
        * (
            -x24 * (x3 * x886 - x52 * x878)
            + 2.0 * x52 * (x3 * x878 - x52 * x883)
            + x881
        )
    )
    result[2, 8] = numpy.sum(
    ...
    result[2, 9] = numpy.sum(
        -x299
        * (
            -x24 * (x3 * x905 - x52 * x902)
            + 2.0 * x52 * (x3 * x902 - x52 * x904)
            + x903
        )
    )
    result[3, 0] = numpy.sum(
    ...
    result[6, 8] = numpy.sum(
        ...
        * (
            ...
            * (
                x1210 * x6
                - x463
                + x494 * (x254 * x455 + x397 - 2.0 * x459 * x494)
                - x643
            )
            + 2.0
            * x6
            * (
                x1210 * x494
                + x466
                + x6 * (x254 * x468 + x392 - 2.0 * x449 * x494)
                + x646
            )
            + 2.0 * x667
            + x980
    ...
    result[9, 2] = numpy.sum(
        ...
        * (
            x1276
            + x24 * (x1275 * x4 - x1278 * x3)
            + 2.0 * x4 * (x1275 * x3 - x1277 * x4)
        )
    )
...
def coulomb3d_34(ax, da, A, bx, db, B, R):
    ...
    result[0, 0] = numpy.sum(
        ...
        * (
            x3
            * (x3 * x71 + x4 * (-x40 + x50 + x66) - x6 * x95 + x98 * (x66 - x96 + x97))
            + x36 * (x71 - x72 + x91 - x94)
            - x6
            * (
                x3 * x95
    ...
    result[0, 6] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x489 - x3 * x509 + x485 + x505 - x509 * x6 + x6 * (x495 + x502))
            - x6
            * (
                x3 * x518
                + x4 * (-x495 + x501 + x509)
    ...
    result[0, 7] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x532 - x3 * x550 + x528 + x546 - x550 * x6 + x6 * (x537 + x543))
            - x6
            * (
                x3 * x559
                + x4 * (-x537 + x542 + x550)
    ...
    result[0, 8] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x572 - x3 * x589 + x568 + x585 - x589 * x6 + x6 * (x577 + x583))
            - x6
            * (
                x3 * x598
                + x4 * (-x577 + x582 + x589)
    ...
    result[0, 9] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x612 - x3 * x632 - x6 * x632 + x6 * (x618 + x625) + x608 + x628)
            - x6
            * (
                x3 * x641
                + x4 * (-x618 + x624 + x632)
    ...
    result[4, 6] = numpy.sum(
        x1661
        * (x1724 + x3 * (x1723 * x5 - x1725 * x6) - x6 * (x1725 * x5 - x1726 * x6))
    )
    result[4, 7] = numpy.sum(
        x1709
        * (x1729 + x3 * (x1728 * x5 - x1730 * x6) - x6 * (x1730 * x5 - x1731 * x6))
    )
    result[4, 8] = numpy.sum(
        x1709
        * (x1734 + x3 * (x1733 * x5 - x1735 * x6) - x6 * (x1735 * x5 - x1736 * x6))
    )
    result[4, 9] = numpy.sum(
        x1661
        * (x1739 + x3 * (x1738 * x5 - x1740 * x6) - x6 * (x1740 * x5 - x1741 * x6))
    )
...
def coulomb3d_41(ax, da, A, bx, db, B, R):
    ...
    result[12, 0] = numpy.sum(
        x271
        * (
            x42 * (x133 * x362 + x321 - x364 * x7)
            - x5 * (x133 * x364 + x323 - x365 * x7)
        )
    )
...
def coulomb3d_42(ax, da, A, bx, db, B, R):
    ...
    result[1, 1] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x403 - x3 * x416 + x400 + x412 - x416 * x6 + x6 * (x406 + x410))
    ...
    result[1, 2] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x434 - x3 * x447 + x431 + x443 - x447 * x6 + x6 * (x437 + x441))
    ...
    result[2, 1] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x564 - x3 * x581 + x560 + x577 - x581 * x6 + x6 * (x569 + x575))
    ...
    result[2, 2] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x599 - x3 * x612 + x596 - x6 * x612 + x6 * (x602 + x606) + x608)
    ...
    result[10, 3] = numpy.sum(
        x108 * (x343 * x952 + 3.0 * x745 - x8 * x953 + 2.0 * x942)
    )
    ...
    result[11, 3] = numpy.sum(
        x397 * (x343 * x985 - x8 * x987 + 2.0 * x817 + 2.0 * x975)
    )
...
def coulomb3d_43(ax, da, A, bx, db, B, R):
    ...
    result[1, 3] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x891 - x3 * x904 - x6 * x904 + x6 * (x894 + x898) + x888 + x900)
            - x6
            * (
                x3 * x913
                + x4 * (-x894 + x897 + x904)
    ...
    result[1, 4] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x921 - x3 * x934 - x6 * x934 + x6 * (x924 + x928) + x918 + x930)
            - x6
            * (
                x3 * x943
                + x4 * (-x924 + x927 + x934)
    ...
    result[1, 5] = numpy.sum(
        ...
        * (
            ...
            * (
            ...
            + x4
            * (x3 * x953 - x3 * x966 - x6 * x966 + x6 * (x956 + x960) + x950 + x962)
            - x6
            * (
                x3 * x975
                + x4 * (-x956 + x959 + x966)
    ...
    result[3, 6] = numpy.sum(
        x1455
        * (x1569 + x3 * (x1568 * x3 - x1570 * x6) - x6 * (x1570 * x3 - x1571 * x6))
    )
    result[3, 7] = numpy.sum(
        x1484
        * (x1578 + x3 * (x1577 * x3 - x1579 * x6) - x6 * (x1579 * x3 - x1581 * x6))
    )
    result[3, 8] = numpy.sum(
        x1484
        * (x1585 + x3 * (x1584 * x3 - x1586 * x6) - x6 * (x1586 * x3 - x1587 * x6))
    )
    result[3, 9] = numpy.sum(
        x1455
        * (x1591 + x3 * (x1590 * x3 - x1592 * x6) - x6 * (x1592 * x3 - x1593 * x6))
    )
    result[4, 0] = numpy.sum(
        x833
        * (
    ...
    result[4, 7] = numpy.sum(
        x1549
        * (x1734 + x3 * (x1733 * x3 - x1735 * x6) - x6 * (x1735 * x3 - x1736 * x6))
    )
    result[4, 8] = numpy.sum(
        x1549
        * (x1740 + x3 * (x1739 * x3 - x1741 * x6) - x6 * (x1741 * x3 - x1742 * x6))
    )
    result[4, 9] = numpy.sum(
    ...
    result[5, 6] = numpy.sum(
        x1455
        * (x1921 + x3 * (x1917 * x3 - x1923 * x6) - x6 * (x1923 * x3 - x1925 * x6))
    )
    result[5, 7] = numpy.sum(
        x1484
        * (x1931 + x3 * (x1928 * x3 - x1933 * x6) - x6 * (x1933 * x3 - x1935 * x6))
    )
    result[5, 8] = numpy.sum(
        x1484
        * (x1940 + x3 * (x1939 * x3 - x1942 * x6) - x6 * (x1942 * x3 - x1944 * x6))
    )
    result[5, 9] = numpy.sum(
        x1455
        * (x1949 + x3 * (x1948 * x3 - x1950 * x6) - x6 * (x1950 * x3 - x1951 * x6))
    )
    result[6, 0] = numpy.sum(
        x782
        * (
    ...
    result[7, 3] = numpy.sum(
        x1549
        * (x2102 + x3 * (x2101 * x5 - x2103 * x6) - x6 * (x2103 * x5 - x2105 * x6))
    )
    result[7, 4] = numpy.sum(
        x1709
        * (x2109 + x3 * (x2108 * x5 - x2110 * x6) - x6 * (x2110 * x5 - x2111 * x6))
    )
    result[7, 5] = numpy.sum(
        x1549
        * (x2115 + x3 * (x2114 * x5 - x2116 * x6) - x6 * (x2116 * x5 - x2117 * x6))
    )
    ...
    result[8, 3] = numpy.sum(
        x1549
        * (x2177 + x3 * (x2176 * x5 - x2178 * x6) - x6 * (x2178 * x5 - x2179 * x6))
    )
    result[8, 4] = numpy.sum(
        x1709
        * (x2182 + x3 * (x2181 * x5 - x2183 * x6) - x6 * (x2183 * x5 - x2184 * x6))
    )
    result[8, 5] = numpy.sum(
        x1549
        * (x2187 + x3 * (x2186 * x5 - x2188 * x6) - x6 * (x2188 * x5 - x2189 * x6))
    )
...
def coulomb3d_44(ax, da, A, bx, db, B, R):
    ...
    result[3, 11] = numpy.sum(
        x1552
        * (x2859 + x3 * (x2858 * x3 - x2860 * x6) - x6 * (x2860 * x3 - x2861 * x6))
    )
    result[3, 12] = numpy.sum(
        x2723
        * (x2868 + x3 * (x2867 * x3 - x2869 * x6) - x6 * (x2869 * x3 - x2871 * x6))
    )
    result[3, 13] = numpy.sum(
        x1552
        * (x2875 + x3 * (x2874 * x3 - x2876 * x6) - x6 * (x2876 * x3 - x2877 * x6))
    )
    ...
    result[4, 11] = numpy.sum(
        x1603
        * (x3 * (x3 * x3157 - x3159 * x6) + x3158 - x6 * (x3 * x3159 - x3160 * x6))
    )
    result[4, 12] = numpy.sum(
        x2751
        * (x3 * (x3 * x3164 - x3166 * x6) + x3165 - x6 * (x3 * x3166 - x3167 * x6))
    )
    result[4, 13] = numpy.sum(
        x1603
        * (x3 * (x3 * x3170 - x3172 * x6) + x3171 - x6 * (x3 * x3172 - x3173 * x6))
    )
    ...
    result[5, 11] = numpy.sum(
        x1552
        * (x3 * (x3 * x3536 - x3542 * x6) + x3540 - x6 * (x3 * x3542 - x3544 * x6))
    )
    result[5, 12] = numpy.sum(
        x2723
        * (x3 * (x3 * x3547 - x3552 * x6) + x3550 - x6 * (x3 * x3552 - x3554 * x6))
    )
    result[5, 13] = numpy.sum(
        x1552
        * (x3 * (x3 * x3558 - x3561 * x6) + x3559 - x6 * (x3 * x3561 - x3563 * x6))
    )
    ...
    result[6, 6] = numpy.sum(
        x1428
        * (x3 * (x3725 * x5 - x3727 * x6) + x3726 - x6 * (x3727 * x5 - x3729 * x6))
    )
    result[6, 7] = numpy.sum(
        x1603
        * (x3 * (x3734 * x5 - x3736 * x6) + x3735 - x6 * (x3736 * x5 - x3737 * x6))
    )
    result[6, 8] = numpy.sum(
        x1603
        * (x3 * (x3740 * x5 - x3742 * x6) + x3741 - x6 * (x3742 * x5 - x3743 * x6))
    )
    result[6, 9] = numpy.sum(
        x1428
        * (x3 * (x3747 * x5 - x3749 * x6) + x3748 - x6 * (x3749 * x5 - x3750 * x6))
    )
    ...
    result[7, 6] = numpy.sum(
        x1603
        * (x3 * (x3907 * x5 - x3909 * x6) + x3908 - x6 * (x3909 * x5 - x3910 * x6))
    )
    result[7, 7] = numpy.sum(
        x3069
        * (x3 * (x3916 * x5 - x3918 * x6) + x3917 - x6 * (x3918 * x5 - x3920 * x6))
    )
    result[7, 8] = numpy.sum(
        x3069
        * (x3 * (x3923 * x5 - x3925 * x6) + x3924 - x6 * (x3925 * x5 - x3926 * x6))
    )
    result[7, 9] = numpy.sum(
        x1603
        * (x3 * (x3929 * x5 - x3931 * x6) + x3930 - x6 * (x3931 * x5 - x3932 * x6))
    )
    ...
    result[8, 6] = numpy.sum(
        x1603
        * (x3 * (x4065 * x5 - x4067 * x6) + x4066 - x6 * (x4067 * x5 - x4068 * x6))
    )
    result[8, 7] = numpy.sum(
        x3069
        * (x3 * (x4070 * x5 - x4072 * x6) + x4071 - x6 * (x4072 * x5 - x4073 * x6))
    )
    result[8, 8] = numpy.sum(
        x3069
        * (x3 * (x4075 * x5 - x4077 * x6) + x4076 - x6 * (x4077 * x5 - x4078 * x6))
    )
    result[8, 9] = numpy.sum(
        x1603
        * (x3 * (x4080 * x5 - x4082 * x6) + x4081 - x6 * (x4082 * x5 - x4083 * x6))
    )
    ...
    result[9, 6] = numpy.sum(
        x1428
        * (x3 * (x4254 * x5 - x4260 * x6) + x4258 - x6 * (x4260 * x5 - x4262 * x6))
    )
    result[9, 7] = numpy.sum(
        x1603
        * (x3 * (x4265 * x5 - x4270 * x6) + x4268 - x6 * (x4270 * x5 - x4272 * x6))
    )
    result[9, 8] = numpy.sum(
        x1603
        * (x3 * (x4276 * x5 - x4279 * x6) + x4277 - x6 * (x4279 * x5 - x4281 * x6))
    )
    result[9, 9] = numpy.sum(
        x1428
        * (x3 * (x4288 * x5 - x4290 * x6) + x4289 - x6 * (x4290 * x5 - x4292 * x6))
    )
        ...
        * (
            ...
            * (
                ...
                * (
                    ...
                    + x4333 * x5
                    - x6
                    * (x4331 * x5 - x6 * (x1261 * x3605 + 3.0 * x2599 - x3615 * x8))
                )
            )
        )
    )
    ...
    result[10, 3] = numpy.sum(
        ...
        * (
            ...
            - x6
            * (x4366 * x5 - x6 * (x1261 * x3684 + 2.0 * x3640 - x3688 * x8 + x3728))
        )
    )
    result[10, 4] = numpy.sum(
        x687
        * (
            ...
            - x6
            * (x4371 * x5 - x6 * (x1261 * x3698 + 3.0 * x2749 + x3668 - x3702 * x8))
        )
    )
    result[10, 5] = numpy.sum(
        x578
    ...
    result[10, 13] = numpy.sum(
        x318 * (x1261 * x3759 + 3.0 * x2875 + x3748 - x3760 * x8)
    )
        ...
        * (
            ...
            * (
                ...
                * (
                    ...
                    + x4399 * x5
                    - x6
                    * (x4397 * x5 - x6 * (x1261 * x3793 + 2.0 * x2940 - x3803 * x8))
                )
            )
        )
    )
    ...
    result[11, 3] = numpy.sum(
        ...
        * (
            ...
            * (
                x4431 * x5
                - x6 * (x1261 * x3869 + 2.0 * x3043 + 2.0 * x3828 - x3875 * x8)
            )
        )
    )
    result[11, 4] = numpy.sum(
    ...
    result[11, 13] = numpy.sum(
        x1428 * (x1261 * x3941 + 2.0 * x3171 + x3930 - x3942 * x8)
    )
    ...
    result[12, 3] = numpy.sum(
        ...
        * (
            ...
            - x6
            * (x4489 * x5 - x6 * (x1261 * x4035 + x3371 + 2.0 * x4003 - x4039 * x8))
        )
    )
    result[12, 4] = numpy.sum(
        x2751
    ...
    result[12, 10] = numpy.sum(
        x578 * (x1261 * x4084 + x3529 + 4.0 * x4066 - x4085 * x8)
    )
    result[12, 11] = numpy.sum(
        x1552 * (x1261 * x4086 + x3540 + 3.0 * x4071 - x4087 * x8)
    )
    result[12, 12] = numpy.sum(
        x2723 * (x1261 * x4088 + x3550 + 2.0 * x4076 - x4089 * x8)
    )
