...
def dipole3d_00(ax, da, A, bx, db, B, R):
    ...
    x2 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x1 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def dipole3d_01(ax, da, A, bx, db, B, R):
    ...
    x6 = (
        ...
        * x0**1.5
        * numpy.exp(
            -x5 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x7 = -x0 * (ax * A[1] + bx * B[1])
    x8 = x7 + B[1]
...
def dipole3d_03(ax, da, A, bx, db, B, R):
    ...
    x10 = (
        ...
        * db
        * numpy.exp(
            -x9 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    x11 = x0**1.5 * x10
...
def dipole3d_12(ax, da, A, bx, db, B, R):
    ...
    x18 = (
        ...
        * db
        * numpy.exp(
            -x17 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
    ...
    # 54 item(s)
    result[0, 0, 0] = numpy.sum(
        x22 * (x0 * (x1 + x11 + x7 + 2.0 * x9) + 2.0 * x15 * x5)
    )
...
def dipole3d_22(ax, da, A, bx, db, B, R):
    ...
    x28 = (
        ...
        * db
        * numpy.exp(
            -x27 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def dipole3d_32(ax, da, A, bx, db, B, R):
    ...
    x56 = 2.0 * x55
    x57 = (
        0.01666666666666667 * x0 * (x1 + x56 + 4.0 * x9)
        + 0.01666666666666667 * x28 * x45
    )
    x58 = x42**2
    x59 = 0.5 * x0
    x60 = x0**1.5 * x36
...
def dipole3d_33(ax, da, A, bx, db, B, R):
    ...
    x47 = (
        ...
        * db
        * numpy.exp(
            -x46 * ((A[0] - B[0]) ** 2 + (A[1] - B[1]) ** 2 + (A[2] - B[2]) ** 2)
        )
    )
...
def dipole3d_42(ax, da, A, bx, db, B, R):
    ...
    x186 = x185 * x56
    x187 = x186 * (
        x0 * (3.0 * x132 + 3.0 * x133 + 2.0 * x159 + 2.0 * x160) + x163 * x87
    )
    x188 = x5 * x56
    x189 = x181 * x188
    x190 = x16 * x52
    ...
    x208 = x185 * x201
    x209 = x208 * (
        x0 * (3.0 * x153 + 3.0 * x154 + 2.0 * x174 + 2.0 * x175) + x109 * x177
    )
    x210 = -x59 - R[1]
    ...
    result[2, 14, 5] = numpy.sum(
        x208
        * (
            x0 * (x177 + 3.0 * x322 + 3.0 * x323 + 2.0 * x330 + 2.0 * x331)
            + x109 * x335
        )
    )
    return result
