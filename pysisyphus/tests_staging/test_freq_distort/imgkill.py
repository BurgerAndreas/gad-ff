...
def do_analysis(geom, nu_thresh=-5.0):
    # Do calculations
    hess = geom.hessian
...
def relax_along_mode(geom, mode, step_size=0.1, max_steps=25, nu_thresh=-5.0):
...
def run_relaxations(geom, mode_ind, nu_thresh=-5.0):
    ...
    for i in range(3):
        ...
        print(
            "Original imargy mode has highest overlap with mode "
