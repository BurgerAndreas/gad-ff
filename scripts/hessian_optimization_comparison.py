...
class HessianBFGSWrapper:
    ...
    def callback(self, x):
        ...
        if (isinstance(self.refresh_policy, int) and 
            self.iteration % self.refresh_policy == 0):
            ...
            for restart in range(10):  # Max 10 restarts
                try:
                    ...
                    sub_result = minimize(
                        ...
                        method='BFGS',
                        jac=True,
                        options={'gtol': 1e-3, 'maxiter': self.refresh_policy, 'hess_inv0': H_inv}
                    )
...
def analyze_results(all_results):
    ...
    # Print summary table
    print(f"{'Strategy':<15} {'Success%':<10} {'Grad Evals':<12} {'Hess Evals':<12} {'Wall Time':<12}")
    print("-" * 75)
    ...
    for strategy in strategies:
        ...
        print(f"{strategy:<15} {success_rate:>7.1f}% {avg_grad_evals:>10.1f} {avg_hess_evals:>10.1f} {avg_wall_time:>9.3f}s")
    ...
    for strategy in strategies:
        ...
        if grad_evals:
            ...
            print(f"{strategy:<15} {min_grad:>10.1f} {max_grad:>10.1f} {std_grad:>10.1f} {efficiency:>10.1f}")
