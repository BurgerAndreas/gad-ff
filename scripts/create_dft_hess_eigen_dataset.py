...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create dft-hess-eigen dataset with DFT Hessian eigenvalues and eigenvectors"
    )
    parser.add_argument(
        "--dataset-file",
        type=str,
    ...
    create_dfteigen_dataset(
        save_hessian=args.save_hessian, dataset_file=args.dataset_file, debug=args.debug
    )
